...
<head>
  ...
  <!-- Basic Page Needs
	================================================== -->
  <meta charset="utf-8">
  <title>Dream Institute-Time Table</title>
    ...
    <div class="row">
      <div class="col-md-8">
        <ul class="list-inline custom-breadcrumb mb-2">
          ...
          <li class="list-inline-item text-white h3 font-secondary nasted">Time Tables</li>
        </ul>
        <p class="text-lighten mb-0">The Time Tables related to the respective subject streams are shown below</p>
      </div>
    </div>
  </div>
</section>
...
<div>
  <div>
    <div style="background-color: white;float: left;width: 50%;height: 400px;">
      <h5><center>Time Table-Art</center></h5>
      <center><table border=1px width=250px bgcolor=white>
            <tr>
              <th>Subject&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
              <th>Monday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
              <th>Tuesday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
            ...
            <tr>
              <td>Logic and scientific method</td>
              <td></td>
              <td>1.00-4.00</td>
              <td>1.00-4.00</td>
              <td></td>
            ...
            <p><a href="Time-Tables\arttime.rar" download="arttime"><u>download</u></a>timetable</p>
        </center>
    </div>

    <div style="background-color: white;float: right; width: 50%;height: 400px;">
        <center>
          <h5>Time Table-Bio</h5>
          <table border=1px width=250px bgcolor=white>
            <tr>
              <th>Subject&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
              <th>Monday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
              <th>Tuesday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
            ...
            <p><a href="Time-Tables\biotime.rar" download="biotime"><u>download</u></a>timetable</p>
        </center>
    </div>
  </div>
    <div>
      <div style="background-color: white;float: left; width: 50%;height: 300px;">
        <center>
          <h5>Time Table-Maths</h5>
          <table border=1px width=250px bgcolor=white>
            <tr>
              <th>Subject&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
              <th>Monday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
            ...
            <p><a href="Time-Tables\mathstime.rar" download="mathstime"><u>download</u></a>timetable</p>
        </center>
     </div>
     <div style="background-color: white;float: right; width: 50%;height: 300px;">
      <center>
          <h5>Time Table-Commerce</h5>
          <table border=1px width=250px bgcolor=white>
            <tr>
              <th>Subject&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
              <th>Monday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
            ...
            <p><a href="Time-Tables\commercetime.rar" download="commerce"><u>download</u></a>timetable</p>
        </center>
    </div>
  </div>
    <div style="background-color: white;width: 100%;">
      <center>
          <h5>Time Table-Technology</h5>
          <table border=1px width=250px bgcolor=white>
            <tr>
              <th>Subject&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
              <th>Monday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
          ...
          <p><a href="Time-Tables\techtime.rar" download="techtime"><u>download</u></a>timetable</p>
        </center>
    </div>
</div>
<!-- footer -->
