...
<head>
  <!-- Basic Page Needs
	================================================== -->
  <meta charset="utf-8">
  <title>Dream Institute - Home</title>
  ...
  <div class="container">
    <div class="hero-slider">
      ...
      <div class="hero-slider-item">
        <div class="row">
          <div class="col-md-8">
            <h1 class="text-white" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".1">Our Institute</h1>
            <p class="text-muted mb-4" data-animation-out="fadeOutRight" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInLeft" data-delay-in=".4">Established in 2010,Our Company Has Been Trusted For 12 Years and Remains in Your Hearts Forever.
            The Reputation Of Our Institution,Which Has a Very Talented Teaching staff,has now spread To The Tour Corners Of The Country.
            Also,With The New Technology,We Have Built A Conducive Environment For Students To Learn and Have Ensured 100% Safety Of The Students.</p>
          </div>
        </div>
      </div>
      <!-- slider item -->
      <div class="hero-slider-item">
        <div class="row">
          <div class="col-md-8">
            <h1 class="text-white" data-animation-out="fadeOutUp" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".1">vission</h1>
            <p class="text-muted mb-4" data-animation-out="fadeOutUp" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInDown" data-delay-in=".4">To Become The Best Place For Educatiton.</p>
          </div>
        </div>
      </div>
      <!-- slider item -->
      <div class="hero-slider-item">
        <div class="row">
          <div class="col-md-8">
            ...
            <p class="text-muted mb-4" data-animation-out="fadeOutDown" data-delay-out="5" data-duration-in=".3" data-animation-in="fadeInUp" data-delay-in=".4">To endow the country with a group of students full of knowledge and virtues.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-xl-8 col-lg-7">
        <div class="row feature-blocks bg-gray justify-content-between">
          <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
            ...
            <h3 class="mb-xl-4 mb-lg-3 mb-4">Subjects Streams</h3>
            <p>All the streams of Art,Commerce,Bio science,Mathematics and Technology are conducted by our institution according to the Advance Level.</p>
          </div>
          <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
            <i class="ti-blackboard mb-xl-4 mb-lg-3 mb-4 feature-icon"></i>
            <h3 class="mb-xl-4 mb-lg-3 mb-4">Teaching Staff</h3>
            <p>Our institute has talented teachers related to every subject stream</p>
          </div>
          <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
            <i class="ti-agenda mb-xl-4 mb-lg-3 mb-4 feature-icon"></i>
            <h3 class="mb-xl-4 mb-lg-3 mb-4">Time Tables</h3>
            <p>You can download the time table of classes related to each stream from this website</p>
          </div>
          <div class="col-sm-6 col-xl-5 mb-xl-5 mb-lg-3 mb-4 text-center text-sm-left">
            <i class="ti-write mb-xl-4 mb-lg-3 mb-4 feature-icon"></i>
            <h3 class="mb-xl-4 mb-lg-3 mb-4">Contact Us</h3>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 order-2 order-md-1">
        <h2 class="section-title">About Dream Institute</h2>
      ...
      <div class="col-md-6 order-1 order-md-2 mb-4 mb-md-0">
        <img class="img-fluid w-100" src="images\dreaminstitute.png" width="100px" height="100px" alt="logo">
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-12">
        <div class="d-flex align-items-center section-title justify-content-between">
          ...
          <div>
            <a href="about.php" class="btn btn-sm btn-outline-primary ml-sm-3 d-none d-sm-block">see all subjects</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <p class="card-text mb-4">Here you van see the subjects conducted in our institution related to the Art stream.</p>
        <a href="about.php" class="btn btn-primary btn-sm">Subjects</a>
      </div>
    </div>
  </div>
  <!-- course item -->
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <p class="card-text mb-4">Here you van see the subjects conducted in our institution related to the Commerce stream.</p>
        <a href="about.php" class="btn btn-primary btn-sm">Subjects</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <a href="about.php">
          <h4 class="card-title">Bio Science</h4>
        </a>
        <p class="card-text mb-4">Here you van see the subjects conducted in our institution related to the Bio sceince stream.</p>
        <a href="about.php" class="btn btn-primary btn-sm">Subjects</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <p class="card-text mb-4">Here you van see the subjects conducted in our institution related to the Maths stream.</p>
        <a href="about.php" class="btn btn-primary btn-sm">Subjects</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-lg-4 col-sm-6 mb-5">
    <div class="card p-0 border-primary rounded-0 hover-shadow">
      ...
      <div class="card-body">
        ...
        <p class="card-text mb-4">Here you van see the subjects conducted in our institution related to the Technology stream.</p>
        <a href="about.php" class="btn btn-primary btn-sm">Subjects</a>
      </div>
    </div>
  </div>
